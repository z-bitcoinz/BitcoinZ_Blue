...
try {
    ...
    try {
        ...
        // 1.5. Initialize the wallet if it exists
        if (walletExists) {
            console.log('\n1.5. Initializing existing wallet...');
            ...
            console.log('   ❌ No wallet found! You need to create a new wallet first.');
            console.log('   💡 Run the Electron app and create a new wallet, then try this script again.');
            return;
        }
